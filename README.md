...
### 方法1 
通过8+2转网线口连接到自己电脑，在自己电脑上跑程序。
可能会遇到各种问题，还是推荐在板载电脑上跑的方法。
### 方法2（有线连接）
通过8+2转网线口连接到自己电脑，通过nomachine放在板载电脑上跑。
具体怎么做看这里https://serviceconsole.unitree.com/#/help/031402
ip是192.168.123.164 ，密码是Unitree0408 。
缺点是线缆很短，不太方便，也挺危险。
### 方法3（无线连接）
b2上目前有插一个无线网卡，可以无线连接。
方法和有线类似，只是IP有改下，可以先有线连接后在板载电脑找这个IP。
比较推荐这个方式，唯一的问题是b2开机的时候无法通过无线连接，要先有线连接一次后才能无线连接。
